...
function DeleteModal({ type, title, onDeleteBtnClick, setIsDeleteModalOpen }) {
  return (
    ...
    <div
      ...
      className="fixed right-0 bottom-0 left-0 top-0 px-2 py-4 overflow-scroll scrollbar-hide
      ...
      >
        ...
        <div className=" flex w-full mt-4 items-center justify-center space-x-4 ">
          <button
            ...
            className="w-full items-center text-white hover:opacity-75 bg-red-500 py-2 
          ...
          <button
            ...
            className="w-full items-center text-[#EFBCD5] dark:bg-white hover:opacity-75 
            bg-[#635fc71a]  py-2 rounded-full font-semibold"
          >
            Cancel
          </button>
        </div>
